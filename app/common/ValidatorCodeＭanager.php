...
class ValidatorCodeＭanager {
	  ...
	  private function createback() {
	   ...
	   //画边框 
	   $bordercolor = imagecolorallocate($this->img, 'a', 'a', 'a');
	  //第四个参数为 验证码边框 在此删除 若在此调用 请按需求操作	
	    imagerectangle($this->img, 0, 0, $this->width-1, $this->height-1);
	  }
